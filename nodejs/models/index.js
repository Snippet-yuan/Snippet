...
// 用户 - 点赞
User.hasMany(PostLike, { foreignKey: "userId", as: "likes", onDelete: "CASCADE" });
...
// 用户 - 收藏
User.hasMany(PostFavorite, { foreignKey: "userId", as: "favorites", onDelete: "CASCADE" });
...
Conversation.belongsTo(User, { foreignKey: "user2Id", as: "user2", onDelete: "CASCADE" });
